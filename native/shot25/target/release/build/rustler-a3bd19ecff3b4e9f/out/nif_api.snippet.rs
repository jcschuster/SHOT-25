...
pub struct DynNifCallbacks {
    ...
    enif_get_int64: Option<extern "C" fn (arg1: *mut ErlNifEnv, term: ERL_NIF_TERM, ip: *mut c_longlong) -> c_int>,
    enif_get_uint64: Option<extern "C" fn (arg1: *mut ErlNifEnv, term: ERL_NIF_TERM, ip: *mut c_ulonglong) -> c_int>,
    enif_make_int64: Option<extern "C" fn (env: *mut ErlNifEnv, i: c_longlong) -> ERL_NIF_TERM>,
    enif_make_uint64: Option<extern "C" fn (env: *mut ErlNifEnv, i: c_ulonglong) -> ERL_NIF_TERM>,
...
#[inline]
pub unsafe extern "C" fn enif_get_int64(arg1: *mut ErlNifEnv, term: ERL_NIF_TERM, ip: *mut c_longlong)
 -> c_int{
...
#[inline]
pub unsafe extern "C" fn enif_get_uint64(arg1: *mut ErlNifEnv, term: ERL_NIF_TERM, ip: *mut c_ulonglong)
 -> c_int{
...
#[inline]
pub unsafe extern "C" fn enif_make_int64(env: *mut ErlNifEnv, i: c_longlong)
 -> ERL_NIF_TERM{
    (DYN_NIF_CALLBACKS.enif_make_int64.unwrap_unchecked())(env, i)
}

/// See [enif_make_uint64](http://www.erlang.org/doc/man/erl_nif.html#enif_make_uint64) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_make_uint64(env: *mut ErlNifEnv, i: c_ulonglong)
 -> ERL_NIF_TERM{
    (DYN_NIF_CALLBACKS.enif_make_uint64.unwrap_unchecked())(env, i)
}
