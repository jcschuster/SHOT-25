defmodule THOU.Tableaux.Branching do
  @moduledoc """
  ...
  import THOU.Util, only: [apply_subst: 2]
  ...
  """
  @spec or_branch(
          [THOU.Tableaux.unif_checkpoint()],
          THOU.Data.Parameters.t(),
          (THOU.Tableaux.unif_checkpoint() ->
             {THOU.Tableaux.unif_checkpoint(), THOU.Tableaux.tableau_res()})
        ) :: THOU.Tableaux.tableau_res()
  ...
  @spec process_result(
          ...
          THOU.Tableaux.unif_checkpoint(),
          THOU.Tableaux.unif_checkpoint()
        ) :: {:halt, THOU.Tableaux.unif_checkpoint()} | {:cont, THOU.Tableaux.unif_checkpoint()}
  ...
  @spec merge_checkpoints(THOU.Tableaux.unif_checkpoint(), [THOU.Tableaux.unif_checkpoint()]) :: [
          THOU.Tableaux.unif_checkpoint()
        ]
  defp merge_checkpoints(original_cp, new_checkpoints) do
    require THOU.Tableaux, as: T
