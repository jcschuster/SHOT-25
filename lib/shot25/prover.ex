defmodule SHOT25.Prover do
  ...
  `SHOT25.Tableaux.tableau/3`, which describes a tableau procedure to satisfy a
  given set of formulas. A formula is proven by negating it and showing that no
  model can be found for this negation.
  """

  import SHOT25.Tableaux
  import SHOT25.Util
  alias SHOT25.Data.{Model, Parameters}
  require Logger
  require Record
  ...
  `SHOT25.Tableaux.tableau/3` can close all branches. Returns a `proof_result`
  describing the output, which can be pretty-printed with a call to
  `SHOT25.PrettyPrint.pp_proof_result/1`.
