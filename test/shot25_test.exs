defmodule SHOT25Test do
  ...
  describe "SHOT25 API delegation - sat/1" do
  ...
  describe "SHOT25 API delegation - sat/2" do
    test "delegates sat/2 with definitions to Prover" do
      p = mk_const_term("p", mk_type(:o, []))
      definitions = %{}
      result = SHOT25.sat(p, definitions)
  ...
  describe "SHOT25 API delegation - sat/3" do
    test "delegates sat/3 with options to Prover" do
      p = mk_const_term("p", mk_type(:o, []))
      definitions = %{}
      result = SHOT25.sat(p, definitions, timeout: 5000)
  ...
  describe "SHOT25 API delegation - prove/1" do
    test "delegates prove/1 to Prover" do
      p = mk_const_term("p", mk_type(:o, []))
      result = SHOT25.prove(p)
  ...
  describe "SHOT25 API delegation - prove/3" do
    test "delegates prove/3 with definitions to Prover" do
      p = mk_const_term("p", mk_type(:o, []))
      q = mk_const_term("q", mk_type(:o, []))
      definitions = %{}
      result = SHOT25.prove(p, [q], definitions)
  ...
  describe "SHOT25 API delegation - prove/4" do
    test "delegates prove/4 with options to Prover" do
      p = mk_const_term("p", mk_type(:o, []))
      q = mk_const_term("q", mk_type(:o, []))
      definitions = %{}
      result = SHOT25.prove(p, [q], definitions, timeout: 5000)
